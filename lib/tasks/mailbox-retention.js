...
let run = async (task, data) => {
    ...
    do {
        ...
        if (taskRetentionCounter < mailboxRetentionCounter) {
            log.verbose(
                'Tasks',
                'task=mailbox-retention id=%s user=%s mailbox=%s status=stale action=continue taskRetentionCounter=%s mailboxRetentionCounter=%s',
                task._id,
                data.user,
                data.mailbox,
            ...
            activeRetentionCounter = mailboxRetentionCounter;
        }
