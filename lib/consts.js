...
module.exports = {
    ...
    // 'mcp' is included so `disabledScopes` can turn the service off for one user through the
    // API. Application passwords may carry it without effect: the MCP listener accepts only
    // dedicated wdmcp_ tokens.
    SCOPES: ['imap', 'pop3', 'smtp', 'mcp'],
