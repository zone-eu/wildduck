...
class MessageHandler {
    ...
    async addAsync(options) {
        ...
        let encryptionKey =
            !alreadyEncrypted && (userData.encryptMessages || !!mailboxData.encryptMessages) && !flags.includes('\\Draft') && tools.getUserEncryptionKey(userData);
        ...
        if (encryptionKey) {
            ...
            if (encryptResult) {
                ...
                log.error('SMIME', 'Encryption returned false for user %s, message stored unencrypted (source: add)', userData._id);
                this.loggelf({
                ...
                if (encryptionKey) {
                    try {
                        ...
                        if (result) {
                            ...
                            log.error('SMIME', 'Encryption returned false for user %s, message stored unencrypted (source: move)', mailboxData.user);
                            this.loggelf({
