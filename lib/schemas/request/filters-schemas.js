...
const FilterAction = Joi.object({
    seen: booleanSchema.allow(null).description('If true then mark matching messages as Seen'),
    flag: booleanSchema.allow(null).description('If true then mark matching messages as Flagged'),
    delete: booleanSchema.allow(null).description('If true then do not store matching messages'),
