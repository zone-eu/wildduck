...
const Attachment = {
    ...
    properties: {
        ...
        content: { type: 'string', minLength: 1, wdRequired: true, description: 'Base64 encoded attachment content' },
        cid: {
            type: 'string',
            maxLength: 255,
            minLength: 1,
...
const ReferenceWithAttachments = {
    ...
    properties: {
        ...
        attachments: {
            // wdEmpty has to sit next to anyOf: inside a branch the convert
            // pre-pass discards it and an empty value becomes a 400
            wdEmpty: true,
            anyOf: [
