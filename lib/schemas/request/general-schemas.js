...
const wildcardAddress = Joi.string()
    ...
    .description('Wildcard address ("*@example.com" or "user@*")');
const addressEmailOrWildcard = Joi.alternatives().try(addressEmail.optional(), wildcardAddress).required().description('E-mail Address or wildcard address');
