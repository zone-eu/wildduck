...
const setVersionedValueScript = fs.readFileSync(__dirname + '/lua/set-versioned-value.lua', 'utf-8');
...
module.exports = redis => {
    ...
    redis.defineCommand('setversionedvalue', {
        numberOfKeys: 2,
        lua: setVersionedValueScript
    });
