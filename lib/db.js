...
module.exports.connect = callback => {
    ...
    if (REDIS_CONF.cluster) {
        module.exports.redis.redisMaster = new Redis(module.exports.redis.nodes('master')[0]); // used for locks and so on, that do not work with or support Redis cluster mode
    }
