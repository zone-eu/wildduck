...
const { getKeywordMaps, getMessageImapFlags } = require('../keyword-handler');
                    ...
                    let processPage = () => {
                        ...
                        let processNext = () => {
                            cursor.next((err, messageData) => {
                                ...
                                if (options.flagsExist || options.markAsSeen) {
                                    messageData.flags = getMessageImapFlags(messageData, keywordMaps.byId);
                                }
