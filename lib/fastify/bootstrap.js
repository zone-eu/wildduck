 ...
 *  - handler errors on validated requests: the restify-era
 *    tools.responseWrapper contract, {error, code?, ...details} with the
 *    IMAP error code mapping; the status stays untouched unless the error
 *    carries a responseCode (legacy paths answer 200 {error})
