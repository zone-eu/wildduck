            ...
            validationObjs: {
                requestBody: {
                    ...
                    smimeCerts: Joi.array()
                        .items(Joi.string().trim().regex(/^-----BEGIN CERTIFICATE-----/, 'PEM certificate format'))
                        .max(16)
                        .default([])
                        .description(
                    ...
                    smimeCipher: Joi.string()
                        ...
                        .description('S/MIME content encryption cipher. Can be overridden per-mailbox.'),
                    smimeKeyTransport: Joi.string()
                        .default(consts.SMIME_DEFAULT_RSA_KEY_TRANSPORT)
                        .description('S/MIME RSA key transport algorithm. Can be overridden per-mailbox.'),
