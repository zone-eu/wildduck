                            ...
                            results: Joi.array()
                                .items(
                                    Joi.object({
                                        ...
                                        description: Joi.string().description('Key description').example('Some notes about this certificate'),
                                        ...
                                        created: Joi.date().description('Datestring').example('2024-03-13T20:06:46.179Z'),
                                        expires: Joi.date().description('Certificate expiration time').example('2024-04-26T21:55:55.000Z'),
                    ...
                    200: {
                        ...
                        model: Joi.object({
                            ...
                            fingerprint: Joi.string()
                                .description('Key fingerprint (SHA1)')
                                .example('59:8b:ed:11:5b:4f:ce:b4:e5:1a:2f:35:b1:6f:7d:93:40:c8:2f:9c:38:3b:cd:f4:04:92:a1:0e:17:2c:3f:f3'),
                            expires: Joi.date().description('Certificate expiration time').example('2024-06-26T21:55:55.000Z'),
                            altNames: Joi.array()
                                .items(Joi.string().required())
                                .required()
                                .description('SAN servernames listed in the certificate')
                    ...
                    200: {
                        ...
                        model: Joi.object({
                            ...
                            fingerprint: Joi.string()
                                ...
                                .example('59:8b:ed:11:5b:4f:ce:b4:e5:1a:2f:35:b1:6f:7d:93:40:c8:2f:9c:38:3b:cd:f4:04:92:a1:0e:17:2c:3f:f3'),
                            expires: Joi.date().description('Certificate expiration time').example('2024-06-26T21:55:55.000Z'),
                            created: Joi.date().description('Created datestring').example('2024-05-13T20:06:46.179Z'),
                            autogenerated: Joi.boolean().description('Was the certificate automatically generated on SNI request'),
                            altNames: Joi.array()
                                .items(Joi.string().required())
                                .required()
