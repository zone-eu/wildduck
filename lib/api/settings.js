                                ...
                                .items(
                                    Joi.object({
                                        ...
                                        value: Joi.alternatives()
                                            .try(
                                                Joi.string().description('Setting value'),
                                                Joi.number().description('Setting value'),
                                                booleanSchema.description('Setting value')
                                            )
                                            .required()
                                        ...
                                        default: Joi.alternatives()
                                            .try(
                                                Joi.string().description('Default value'),
                                                Joi.number().description('Default value'),
                                                booleanSchema.description('Default value')
                                            )
                                            .required()
