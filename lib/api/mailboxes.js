...
const GetMailboxesResult = {
    ...
    // modifyIndex and subscribed are echoed straight from the mailbox document
    // and may be absent on records written outside the API; fast-json-stringify
    // THROWS on a missing required key, which would fail the whole listing
    required: ['id', 'name', 'path', 'hidden', 'encryptMessages']
};
                ...
                response: {
                    200: {
                        ...
                        model: {
                            ...
                            // modifyIndex and subscribed are echoed from the db document, see getMailboxesResult
                            required: ['success', 'id', 'name', 'path', 'hidden', 'encryptMessages']
                        }
                    }
                }
            }
