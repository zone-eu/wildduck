            ...
            validationObjs: {
                ...
                response: {
                    200: {
                        ...
                        model: Joi.object({
                            success: successRes,
                            type: Joi.string().description('Optional webhook type filter'),
                            user: Joi.string().allow(null).description('Optional user filter'),
                            total: totalRes,
                            page: pageRes,
                            ...
                            results: Joi.array()
                                .items(
                                    Joi.object({
                                        ...
                                        user: Joi.string().allow(null).required().description('User ID or null'),
