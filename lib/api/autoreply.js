                    ...
                    200: {
                        ...
                        model: Joi.object({
                            ...
                            html: Joi.string()
                                ...
                                .max(128 * 1024)
                                .description('HTML formatted content of the autoreply message'),
                            start: Joi.date().empty('').description('Datestring of the start of the autoreply or undefined if missing'),
                            end: Joi.date().empty('').description('Datestring of the end of the autoreply or undefined if missing'),
                            created: Joi.date().description('Datestring of when the Autoreply was created or undefined if missing')
