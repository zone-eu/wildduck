...
const { dateOrFalse } = require('../schemas/json-schemas');
...
const autoreplyBoundary = dateOrFalse;
    ...
    server.put(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            const autoreplyData = await db.database
                ...
                .findOneAndUpdate({ user }, { $set: values }, { returnDocument: 'after', upsert: true });
                        ...
                        model: {
                            ...
                            properties: {
                                ...
                                created: {
                                    type: 'string',
                                    format: 'date-time',
                                    description: 'Datestring of when the Autoreply was created or undefined if missing'
                                }
                            },
                            required: ['success']
                        }
