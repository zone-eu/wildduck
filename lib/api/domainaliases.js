...
const aliasIdParam = objectIdSchema('ID of the Alias', { wdRequired: true });
                ...
                response: {
                    200: {
                        ...
                        model: {
                            ...
                            // created is echoed from the db document and may be absent on legacy records
                            required: ['success', 'id', 'alias', 'domain']
                        }
                    }
                }
            }
