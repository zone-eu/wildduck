                            ...
                            properties: {
                                ...
                                results: {
                                    ...
                                    items: {
                                        ...
                                        required: ['id', 'description', 'scopes', 'lastUse', 'created']
                                    }
                                }
                            },
                ...
                response: {
                    200: {
                        ...
                        model: {
                            ...
                            required: ['success', 'id', 'description', 'scopes', 'lastUse', 'created']
                        }
                    }
                }
            }
                    ...
                    200: {
                        ...
                        model: {
                            ...
                            properties: {
                                ...
                                address: {
                                    type: 'string',
                                    description: 'Account address or the address specified in params of this endpoint. Present when generateMobileconfig is true.'
                                }
                            },
